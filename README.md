...
<h3>Projeto realizado para a Sprint 4 da matéria de Python</h3>
<h4>Solução desenvolvida para o Passa A Bola, um dos principais canais de notícia sobre o Futebol Feminino</h4>

# Funcionalidades do projeto
- `Arbitras`: Adiciona, Lista, Atualiza e exclui são as principais funções.
- `Comentaristas`: Adiciona, Lista, Atualiza e exclui são as principais funções.
- `Organizadoras`: Recebe o nome do Passa a Bola e anuncia.
